...
class Activecampaign_For_Woocommerce_Ecom_Cofe_Product_Serializer {
	...
	public static function product_array_for_cofe( $product, ?int $connection_id, $parent = null ): ?array {
		...
		if ( $cofe_product ) {
			...
			try {
				...
				$cofe_product['variantDescription']       = ( new Activecampaign_For_Woocommerce_Ecom_Cofe_Product_Serializer() )->clean_description( $product->get_description(), 0 );
	...
	public static function base_product_fields( $base_product ): array {
		...
		try {
			...
			$cofe_product['baseProductDescription']       = ( new Activecampaign_For_Woocommerce_Ecom_Cofe_Product_Serializer() )->clean_description( $base_product->get_description(), 0 );
