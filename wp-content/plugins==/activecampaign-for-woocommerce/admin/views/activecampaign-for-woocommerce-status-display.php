...
<div id="activecampaign_status" label="
	...
	<table class="wc_status_table widefat status_activecampaign_checklist" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				if ( false === $activecampaign_for_woocommerce_status_data['woocommerce_latest_version'] ) {
					...
					if ( isset( $activecampaign_for_woocommerce_api_response['offers'][0]['version'] ) ) {
				...
				if ( isset( $activecampaign_for_woocommerce_latest_version ) && version_compare( $activecampaign_for_woocommerce_status_data['wc_environment']['wp_version'], $activecampaign_for_woocommerce_latest_version, '<' ) ) {
				...
				?>
				<?php if ( $activecampaign_for_woocommerce_status_data['wc_environment']['wp_version'] > 6 ) : ?>
					<?php $this->output_yes_mark( esc_html( $activecampaign_for_woocommerce_status_data['wc_environment']['wp_version'] ) ); ?>
				<?php endif; ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<?php
				if ( version_compare( $activecampaign_for_woocommerce_status_data['wc_environment']['php_version'], '7.4', '>=' ) ) {
