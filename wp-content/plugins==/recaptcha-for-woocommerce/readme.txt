...
* Fixed issue of reCaptcha V2 token unset on ajax call


= 2.52 =

* Fixed issue of Apple Pay/Google Pay not working in Stripe Payment Gateway


= 2.51 =

* Fixed issue of broken json while user loged in and try payment using Intuit Payment processer
