            ...
            <div class="campaignformwrp">
              <form id="edit-pmax-campaign-form" method="post">
                <div class="form-row campform-row">
                  ...
                  <input type="text" class="fromfiled" style="pointer-events: none; background: #f2f2f2;" name ="campaign_name" id="campaign_name" value="<?php echo esc_attr($this->object_value($this->campaign, "name")); ?>" placeholder="<?php esc_html_e("Enter Campaign Name","enhanced-e-commerce-for-woocommerce-store"); ?>" required>
                </div>
                <div class="form-row campform-row">
