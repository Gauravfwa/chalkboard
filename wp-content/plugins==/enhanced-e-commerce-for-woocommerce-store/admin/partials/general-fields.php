  ...
  <div class="row justify-content-center">
    ...
    <div class="convfixedcontainermid col-md-8 col-xs-12 m-0 p-0">
      ...
      <div id="conv_pixel_list_box" class="shadow-sm">
            ...
            <?php if ((empty($pixel_not_connected['microsoft_ads_pixel_id']) || empty($pixel_not_connected['msclarity_pixel_id']))  && $conv_gtm_not_connected == "conv-gtm-connected") { ?>
              <div class="d-flex pt-2">
                ...
                if (isset($data['msclarity_pixel_id']) && $data['msclarity_pixel_id'] != '') { ?>
                  <span class="pe-2 m-0"> <?php echo esc_attr($data['msclarity_pixel_id']); ?> </span>
                <?php }
                ?>
        ...
        <div class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo $conv_gtm_not_connected; ?>">
          <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
            <img class="align-self-center" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_hotjar_logo.png'); ?>" />
          </div>
          ...
          <div class="ms-auto d-flex">
            ...
            <?php } else { ?>
              <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not Connected</span>
            <?php } ?>
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage="hotjarsettings"'); ?>" class="rounded-end convcard-right-arrow align-self-center link-dark">
              <span class="material-symbols-outlined p-2">chevron_right</span>
            </a>
          </div>
        </div>
        ...
        <div class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo $conv_gtm_not_connected; ?>">
          <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
            <img class="align-self-center" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_crazyegg_logo.png'); ?>" />
          </div>
          ...
          <div class="ms-auto d-flex">
            ...
            <?php } else { ?>
              <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not Connected</span>
            <?php } ?>
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage="crazyeggsettings"'); ?>" class="rounded-end convcard-right-arrow align-self-center link-dark">
              <span class="material-symbols-outlined p-2">chevron_right</span>
            </a>
          </div>
        </div>
...
<script>
  ...
  jQuery(function() {
    ...
    jQuery('#starttrackingbut').click(function() {
      ...
      var ecrandomstring = "<?php echo $TVC_Admin_Helper->generateRandomStringConv(); ?>";
      var subscription_id = "<?php echo $subscription_id; ?>";
      var fronturl = '<?php echo site_url(); ?>?is_calc_on=1&ec_token=' + ecrandomstring;
