                    ...
                    foreach ($feed_data as $value) {
                        ...
                        <tr class="height">
                            <td class="align-middle text-start">
                                <div class="form-check form-check-custom">
                                    <input class="form-check-input checkbox_feed fs-17" <?php echo $value->status == 'Synced' ? '' : 'disabled="disabled"' ?> type="checkbox" name="" id="checkFeed_<?php echo esc_html($value->id); ?>" value="<?php echo esc_html($value->id); ?>">
                                </div>
                            </td>
                            <td class="align-middle text-start">
        ...
        <div class="modal-content ">
            <form id="CampaignForm" onfocus="this.className='focused'">
                ...
                <div class="modal-header bg-light p-2 ps-4">
                    ...
                    &nbsp; <h5 class="modal-title fs-16"><?php echo $google_ads_id !== '' ? '- Google Ads Id - '.$google_ads_id : '' ?></h5>
                    ...
                    <div class="mb-2 row">
                        <div class="col-6">
                            <label for="daily_budget" class="col-form-label text-dark fs-14 fw-500">
                                ...
                                (<span class="ga_currency_symbols"><?php echo esc_attr($currency_symbol); ?></span>)
                                <span class="text-danger fs-16">*</span>
                            </label>
                            <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip"
                                data-bs-placement="right"
...
<script>  
    ...
    var feedId = "<?php echo $feedIdString ?>"; //Get all feedId 
    ...
    jQuery(document).on('click', '#submitCampaign', function () {
        ...
        let subscriptionId = "<?php echo $subscriptionId ?>";
        let google_merchant_center_id = "<?php echo $google_merchant_center_id ?>";
        let google_ads_id = "<?php echo $google_ads_id ?>";
        let store_id = "<?php echo $google_detail['setting']->store_id ?>";
    ...
    jQuery(document).on('click', '.gotopmaxlist', function() {
        window.location.replace("<?php echo esc_url_raw($site_url_pmax); ?>");
    })
