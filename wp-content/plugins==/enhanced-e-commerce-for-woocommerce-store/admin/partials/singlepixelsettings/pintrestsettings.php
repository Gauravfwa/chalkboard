...
<script>
    jQuery(function() {
        jQuery("#upgradetopro_modal_link").attr("href", '<?php echo esc_url_raw($TVC_Admin_Helper->get_conv_pro_link_adv("popup", "pintrestsettings",  "conv-link-blue fw-bold", "linkonly")); ?>');
    });
