...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
        ...
        <div class="alert d-flex align-items-cente p-0" role="alert">
            ...
            <div class="p-2 w-100 rounded-end border border-start-0 shadow-sm conv-notification-alert lh-lg">
                <ul style="list-style:disc;">
                    <li><?php esc_html_e($pixel_settings_arr[$subpage]['topnoti'], "enhanced-e-commerce-for-woocommerce-store"); ?></li>
    ...
    <form id="gadssetings_form" class="convpixsetting-inner-box mt-4">
        <div>
                ...
                <div class="row pt-2">
                    ...
                    <div class="col-12 flex-row pt-3">
                        ...
                        <div class="col-12 py-2">
                            ...
                            <img style="cursor: default;" src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/BFriday-Google-Ads-Screen-Image.png'); ?>" />
                        </div>
                    </div>
            ...
            <input type="hidden" id="merchant_id" name="merchant_id" value="<?php echo $googleDetail->merchant_id ?>">
        <input type="hidden" id="google_merchant_id" name="google_merchant_id" value="<?php echo $googleDetail->google_merchant_id ?>">
