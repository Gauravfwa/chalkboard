    ...
    if (isset($eeoptions) && !empty($eeoptions)) {
      ...
      if ($gadsid == "" && !array_key_exists('blackfriday2023', $ee_convnotice)) { ?>
        <div data-dismissible="convbfriday-forever" class="updated notice notice-success is-dismissible conversios_topnotice" data-convnotiid="blackfriday2023">
          <p>
            <?php _e('Create a new google ads account using Conversios plugin and get $500 rewards when you spend $500 in the first 60 days**', 'enhanced-e-commerce-for-woocommerce-store'); ?>
          </p>
          <p>
            <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-analytics&subpage=gadssettings'); ?>">
              <?php _e('Connect Now', 'enhanced-e-commerce-for-woocommerce-store'); ?>
            </a>
          </p>
        </div>
