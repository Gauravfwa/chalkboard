...
class Enhanced_Ecommerce_Google_Analytics_Public extends Con_Settings
{
  ...
  public function tvc_call_hooks()
  {
    ...
    $iseconn = isset($_REQUEST['is_calc_on']) && $_REQUEST['is_calc_on'] == "1" ? $_REQUEST['is_calc_on'] : "";
  ...
  public function conv_add_ec_code_front()
  {
    ...
    wp_enqueue_script('convec_jspdf', esc_url_raw('https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js'), array('jquery'), '', true);
    wp_enqueue_script('convec_htmcanvas', esc_url_raw('https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js'), array('jquery'), '', true);
    wp_enqueue_script('convec_popup', esc_url_raw('https://wp.conversios.io/ec/convempopup.js'), array('jquery'), time(), true);
