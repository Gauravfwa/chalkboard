...
class LDX_Design_Upgrade_Pro_Learndash_Customizer {
	...
	public function ldx_register_customize_sections( $wp_customize ) {
		...
		if ( 'legacy' === $template ) { // @legacy
			...
			$wp_customize->add_section( 'ldx_learndash_course_grid', array(
				...
				'description' => __( 'These styles apply to the LearnDash Course Grid add-on and/or the Uncanny LearnDash Toolkit Pro Enhanced Course Grid.', 'design-upgrade-pro-learndash' ),
				'panel'    => 'ldx_learndash_styles_panel',
				'priority' => 190
			) );
			...
			$wp_customize->add_section( 'ldx3_learndash_buttons', array(
				'title'    => __( 'Buttons', 'design-upgrade-pro-learndash' ),
				'description' => __( 'These styles only affect LearnDash buttons (previous/next ', 'design-upgrade-pro-learndash' ) . LearnDash_Custom_Label::label_to_lower( 'lesson' ) . __( ', mark complete, expand all, etc.).', 'design-upgrade-pro-learndash' ),
				'panel'    => 'ldx3_learndash_styles_panel',
				'priority' => 120
			) );
			...
			$wp_customize->add_section( 'ldx3_learndash_list_tables', array(
				...
				'description' => __( 'Styles applied to the "', 'design-upgrade-pro-learndash' ) . LearnDash_Custom_Label::get_label( 'course' ) . __( ' Content" table displayed at the bottom of a ', 'design-upgrade-pro-learndash' ) . LearnDash_Custom_Label::label_to_lower( 'course' ) . __( ' page.', 'design-upgrade-pro-learndash' ),
				'panel'    => 'ldx3_learndash_styles_panel',
				'priority' => 130
			) );
			...
			$wp_customize->add_section( 'ldx3_learndash_course_page', array(
				'title'    => LearnDash_Custom_Label::get_label( 'course' ) . __( ' Page', 'design-upgrade-pro-learndash' ),
				'description' => __( 'These styles only affect the ', 'design-upgrade-pro-learndash' ) . LearnDash_Custom_Label::label_to_lower( 'course' ) .  __( ' page for users who are <strong>not</strong> enrolled.', 'design-upgrade-pro-learndash' ),
				'panel'    => 'ldx3_learndash_styles_panel',
				'priority' => 140
			) );
			...
			$wp_customize->add_section( 'ldx3_learndash_focus_mode', array(
				...
				'description' => __( 'These styles apply to all Focus Mode pages when Focus Mode is enabled in your LearnDash settings.', 'design-upgrade-pro-learndash' ),
				'panel'    => 'ldx3_learndash_styles_panel',
				'priority' => 150
			) );
			...
			$wp_customize->add_section( 'ldx3_learndash_course_nav', array(
				...
				'description' => __( 'These styles apply to the Focus Mode sidebar AND the ', 'design-upgrade-pro-learndash' ) . LearnDash_Custom_Label::get_label( 'course' ) . __( ' Navigation widget.', 'design-upgrade-pro-learndash' ),
				'panel'    => 'ldx3_learndash_styles_panel',
				'priority' => 160
			) );
			...
			if ( defined( 'WDM_LD_COURSE_VERSION' ) ) {
				...
				$wp_customize->add_section( 'ldx3_wisdm_ratings_reviews', array(
					...
					'description' => __( 'These styles apply to the WisdmLabs Ratings, Reviews & Feedback plugin.', 'design-upgrade-pro-learndash' ),
					'panel'    => 'ldx3_learndash_styles_panel',
					'priority' => 230
				) );
	...
	private function ldx3_learndash_focus_mode_section( $wp_customize ) {
		...
		/* Focus Mode: Top Menu: Background Color */
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ldx3_design_upgrade[focus_mode_topmenu_bg_color]', array(
			'label'    => __( 'Top Menu: Background', 'design-upgrade-pro-learndash' ),
			'section'  => 'ldx3_learndash_focus_mode',
			'settings' => 'ldx3_design_upgrade[focus_mode_topmenu_bg_color]',
			'priority' => 40
		) ) );

		/* Focus Mode: Top Menu: Text Color */
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ldx3_design_upgrade[focus_mode_topmenu_text_color]', array(
			'label'    => __( 'Top Menu: Text', 'design-upgrade-pro-learndash' ),
			'section'  => 'ldx3_learndash_focus_mode',
	...
	private function ldx3_learndash_course_page_section( $wp_customize ) {
		...
		/* Course Status: Background Color */
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ldx3_design_upgrade[course_status_bg_color]', array(
			'label'       => LearnDash_Custom_Label::get_label( 'course' ) . __( ' Status: Background', 'design-upgrade-pro-learndash' ),
			'section'     => 'ldx3_learndash_course_page',
			'settings'    => 'ldx3_design_upgrade[course_status_bg_color]',
			'priority'    => 10
		) ) );

		/* Course Status: Text Color */
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ldx3_design_upgrade[course_status_text_color]', array(
			'label'       => LearnDash_Custom_Label::get_label( 'course' ) . __( ' Status: Text', 'design-upgrade-pro-learndash' ),
			'section'     => 'ldx3_learndash_course_page',
			'settings'    => 'ldx3_design_upgrade[course_status_text_color]',
			'priority'    => 11
		) ) );

		/* Course Status: Border Width */
		...
		$wp_customize->add_control( 'ldx3_design_upgrade[course_status_border_width]', array(
			'label'    => LearnDash_Custom_Label::get_label( 'course' ) . __( ' Status: Border Width', 'design-upgrade-pro-learndash' ),
			'type'        => 'number',
			'input_attrs' => array(
				'min'   => 1,
				'max'   => 100,
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ldx3_design_upgrade[course_status_border_color]', array(
			'label'       => LearnDash_Custom_Label::get_label( 'course' ) . __( ' Status: Border Color', 'design-upgrade-pro-learndash' ),
			'section'     => 'ldx3_learndash_course_page',
